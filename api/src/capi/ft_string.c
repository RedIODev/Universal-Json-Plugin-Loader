...
#define FLAG_SIZE sizeof(StringDeallocFP) + sizeof(c8 *)
...
String createString(const c8 *data, usize length, StringDeallocFP deallocator)
{
    if (data == NULL)
    {
...
void destroyString(String *string)
{
    ...
    StringDeallocFP tmp_fn = str->dealloc_fn;
    str->data = NULL;
    str->dealloc_fn = NULL;
    NULL_GUARD(tmp_fn, )
